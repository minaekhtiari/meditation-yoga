...
import apps.hillavas.com.yoga.adapters.RecyclerView_Adapter_FirstContentActivity_category3;
import apps.hillavas.com.yoga.activity.MessagingActivity;
...
import apps.hillavas.com.yoga.data.models.YogaContent;
import apps.hillavas.com.yoga.classes.tools.DateMounthIntToStr;
...
//        nestedScrollView = (NestedScrollView) getActivity().findViewById(R.id.fragment_article_nestedScroll);
        ...
        protected void onPostExecute(Home_Pager_Page page) {
            ...
            if(content.isIsFree()){
                ...
                if(content.getPrice() > 0) {
                    price = getString(R.string.buyed);
                ...
                lock = true;
                price = content.getPrice() + getString(R.string.rial);
    ...
    private void gotoBuy(){
        ...
        strTitrBuyDialog = String.format(getString(R.string.buy_message), content.getSubject(), content.getPrice());
