...
import apps.hillavas.com.yoga.adapters.RecyclerView_Adapter_Category;
import apps.hillavas.com.yoga.adapters.RecyclerView_Adapter_CategoryTitrs;
import apps.hillavas.com.yoga.data.models.CategoryWithParentChild;
import apps.hillavas.com.yoga.data.models.Level;
...
//        ivMenu.setImageResource(R.drawable.back_icon);
        ((TextView)findViewById(R.id.toolbar_home_frameTitle_text)).setText(R.string.filter_1);
