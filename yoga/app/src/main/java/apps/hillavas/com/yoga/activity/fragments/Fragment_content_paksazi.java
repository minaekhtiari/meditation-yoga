...
public class Fragment_content_paksazi extends Fragment implements View.OnClickListener{
    ...
    RelativeLayout relativePaksaziEtemad;
    RelativeLayout relativePaksaziKeria;


    @Nullable
    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        return inflater.inflate(R.layout.fragment_yoga_category_paksazi, container , false);
    }
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        relativePaksaziEtemad = (RelativeLayout) getActivity().findViewById(R.id.fragment_yoga_category_paksazi_etemadbenafs);
        relativePaksaziKeria = (RelativeLayout) getActivity().findViewById(R.id.fragment_yoga_category_paksazi_keria);
        relativePaksaziEtemad.setOnClickListener(this);
        relativePaksaziKeria.setOnClickListener(this);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.fragment_yoga_category_paksazi_etemadbenafs: {
                categoryIdSelected = 16;
...
//                sharedPreferencesHome.edit().putInt(CATEGORY_ID , 10).commit();
                ...
                tvToolbarTitle.setText(R.string.self_confidence);
                break;
            }
            case R.id.fragment_yoga_category_paksazi_keria: {
                categoryIdSelected = 17;
                if (sharedPreferencesHome.getInt(CATEGORY_ID, 0) != categoryIdSelected) {
                    if (recyclerView != null)
                        recyclerView.setVisibility(View.INVISIBLE);
                    new TaskLoadContents().execute(categoryIdSelected);
...
//                sharedPreferencesHome.edit().putInt(CATEGORY_ID , 10).commit();
                ((FrameLayout) getActivity().findViewById(R.id.firstContentActivity_frameBase)).setVisibility(View.INVISIBLE);
                ((FrameLayout) getActivity().findViewById(R.id.firstContentActivity_frameBase2)).setVisibility(View.VISIBLE);
                tvToolbarTitle.setText(R.string.keria);
                break;
            }
        }
