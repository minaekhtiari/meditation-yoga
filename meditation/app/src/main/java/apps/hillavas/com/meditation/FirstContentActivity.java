...
import fragments.Fragment_content_level1;
import fragments.Fragment_contents;
...
//        getWindow().getDecorView().setLayoutDirection(View.LAYOUT_DIRECTION_RTL);
        ...
        credit = sharedPreferencesHome.getInt(CREDIT, 0) + "";
        ...
        tvCredit = (TextView) findViewById(R.id.fragment_personalInfo_text_credit);
//        tvAddCredit = (TextView) findViewById(R.id.fragment_personalInfo_text_buyCredit);
...
//        tvAddCredit.setOnClickListener(this);
        ...
        tvName.setText(name);
        tvWeight.setText(" وزن : " + weight+" کیلوگرم ");
        ...
        ActionBarDrawerToggle mDrawerToggle = new ActionBarDrawerToggle(this, drawerLayout,
            ...
            public void onDrawerOpened(View drawerView) {
                ...
                tvWeight.setText(" وزن : " + sharedPreferencesHome.getInt(WEIGHT , 0)+" کیلوگرم ");
    ...
    public void onClick(View v) {
        switch (v.getId()){
//            case R.id.fragment_personalInfo_text_buyCredit:{
...
//            }
    ...
    public void onBackPressed() {
        ...
        ((TextView)findViewById(R.id.toolbar_home_frameTitle_text)).setText("مدیتیشن");
    }
    ...
    class TaskGetProfileInfo extends AsyncTask<Integer, Void, ProfileInfo> {

        ProfileInfo pf;
        @Override
        protected ProfileInfo doInBackground(Integer... params) {

            try {
                if (RetrofitFactory.getRetrofitClient().getProfileInfo(token).execute().body().isIsSuccessfull())
                    pf = RetrofitFactory.getRetrofitClient().getProfileInfo(token).execute().body().getResult();
            } catch (IOException e) {
                e.printStackTrace();
            }
            return pf;
        ...
        protected void onPostExecute(ProfileInfo profileInfo) {
            ...
            if(profileInfo != null && profileInfo.getCredit() > 0) {
                tvCredit.setText(" اعتبار فعلی : " + profileInfo.getCredit() + " ریال ");
